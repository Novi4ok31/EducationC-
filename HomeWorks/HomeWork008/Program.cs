...
int[,] SortingElementsArray (int[,] array)
{
    for (int i = 0; i < array.GetLength(0); i++)
    {
        for (int j = 0; j < array.GetLength(1); j++)
...
Console.WriteLine($"The index of row with minimum sum of elements is {result}");
*/
/*
...
Console.WriteLine();
int[,] result = Multiplication(firstArray, secondArray);
Show2dArray(result);
